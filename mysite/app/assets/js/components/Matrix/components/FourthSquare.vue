<template>
    <article class="message is-danger">
      <div class="message-header">
        <p>Не важные и не срочные дела</p>
      </div>
      ...
      <div class="box hellow">
        <div class="matrix_field field">
          <div class="control">
            <input class="input is-danger" v-model="current_text" type="text" placeholder="Primary input">
          </div>
        </div>
        <button class="button is-danger my-button" @click="add_todo()">Добавить</button>
      </div>
